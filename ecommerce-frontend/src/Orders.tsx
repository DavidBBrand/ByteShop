...
const Orders = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <h2 className="text-3xl font-bold mb-8 bg-linear-to-r from-amber-200 to-orange-700 bg-clip-text text-transparent">
        Order History
      </h2>
          ...
          {orders.map(order => (
            ...
            >
              <div className="flex justify-between items-center border-b border-gray-700 pb-4 mb-4">
                <div>
                  <p className="text-xs text-gray-300 uppercase tracking-wider">Order ID</p>
                  <p className="font-mono text-orange-300">#00{order.id}</p>
                </div>
                <div className="text-right">
                  <p className="text-xs text-rose-200 uppercase tracking-wider">Date</p>
              ...
              <div className="mt-6 pt-4 border-t border-gray-700 flex justify-between items-center">
                <span className="text-gray-400 font-bold uppercase text-xs">Total Paid</span>
