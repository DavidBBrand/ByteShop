  ...
  return (
    <div className="group flex flex-col overflow-hidden rounded-xl border border-gray-700 bg-gray-800 shadow-sm transition-all hover:shadow-md hover:border-orange-500/50">
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <p className="mb-4 text-xs text-gray-400 line-clamp-2 italic">{product.description}</p>

        <div className="flex items-center justify-between mb-4 mt-auto">
          {product.stock_quantity > 0 ? (
            <div className="flex flex-col">
              <span className="text-emerald-400 text-[10px] font-black uppercase tracking-widest">In Stock</span>
              <span
            ...
            <span className="text-rose-600 text-[10px] font-black uppercase tracking-widest">Out of Stock</span>
          )}
        </div>
