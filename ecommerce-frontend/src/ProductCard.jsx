    ...
    <div className="group flex flex-col overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm transition-all hover:shadow-md">
      ...
      <div className="flex flex-1 flex-col p-4">
        ...
        <button
          ...
          className="mt-auto w-full rounded-lg bg-blue-600 py-2.5 text-sm font-semibold text-white transition-colors hover:bg-blue-700 active:scale-95 disabled:bg-slate-300 disabled:cursor-not-allowed"
        >
          Add to Cart
        </button>
      </div>
